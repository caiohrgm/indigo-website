const domains = [
  ...
  { title: 'Policiamento', desc: 'Drones táticos e IA para segurança de fronteira.' },
  { title: 'Guerras de Facções', desc: 'Apoio estratégico e armamento inteligente.' },
...
export function Domains() {
  return (
    <section id="domains" className="py-16 bg-[#D8DAD3] px-6">
      <h3 className="text-3xl font-semibold text-[#4A4A48] mb-8 text-center">Áreas de Atuação</h3>
