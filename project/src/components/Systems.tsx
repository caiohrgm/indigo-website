...
//         A Indigo Technologies possui uma presença marcante na galáxia, atuando em mais de 300 sistemas.
//       </p>
                ...
                <tr key={index} className="border-b hover:bg-gray-50">
                  ...
                  <td className="px-4 py-2 flex items-center gap-2">
                    {system.is_leader === "yes" ? (
                      <>
                        <FaCrown className="text-yellow-500" title="Controlado pela Indigo" />
                        <span className="text-indigo-600 font-semibold">Indigo</span>
                      </>
                    ) : (
                      <>
                        <FaTimesCircle className="text-red-500" title="Sistema concorrente" />
