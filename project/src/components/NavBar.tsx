  ...
  return (
    <nav className="bg-[#f7f2e8] shadow-md px-6 py-4 sticky top-0 z-50">
      <div className="flex justify-between items-center">
        ...
        {/* Menu desktop (ajuste de tamanho e alinhamento) */}
        <ul className="hidden md:flex gap-8 md:text-base lg:text-lg font-medium text-[#4A4A48]">
          <li><a href="#about" className="hover:text-indigo-blue font-exo-2 font-semibold">Sobre</a></li>
          <li><a href="#domains" className="hover:text-indigo-blue font-exo-2 font-semibold">Atuação</a></li>
          <li><a href="#systems" className="hover:text-indigo-blue font-exo-2 font-semibold">Sistemas</a></li>
          <li><a href="#alliance" className="hover:text-indigo-blue font-exo-2 font-semibold">Aliança</a></li>
          <li><a href="#contact" className="hover:text-indigo-blue font-exo-2 font-semibold">Contato</a></li>
        </ul>
      </div>
